...
const ctas = [
    ...
    { title: "My Projects", sub: "Explore Projects", href: "/showcase#projects" },
];

export default function Footer() {
    return (
        <footer data-aos="fade-up" className="bg-background px-4 pb-4 pt-0">
            <div className="rounded-2xl border border-border bg-card overflow-hidden">
                ...
                <div className="grid grid-cols-1 gap-10 px-6 pt-8 pb-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="flex flex-col gap-2" data-aos="fade-right" data-aos-duration="500">
                    ...
                    <div data-aos="fade-right" data-aos-duration="750">
                        ...
                        <nav className="flex flex-col gap-2">
                            {[
                                ...
                                <Link key={label} href={href} className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2 group" >
                                    ...
                                    >
                                        {icon === "/icons/github.svg" && (
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                                d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.164 6.839 9.489.499.09.68-.217.68-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.09-.646.35-1.086.636-1.336-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.748-1.025 2.748-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.335-.011 2.415-.011 2.743 0 .267.177.578.687.48C19.138 20.161 22 16.418 22 12c0-5.523-4.477-10-10-10z"
                                                fill="currentColor"
                                            />
                                        )}
                                        {icon === "/icons/youtube.svg" && (
                    ...
                    <div data-aos="fade-right" data-aos-duration="1250">
                        ...
                        <div className="flex flex-col divide-y divide-border">
                            {ctas.map(({ title, sub, href }) => (
                                <Link key={title} href={href} className="flex items-center justify-between py-3 group" >
                                    <div>
                ...
                <div data-aos="fade-right" data-aos-duration="500" className="px-5 leading-none select-none pointer-events-none border-t border-border/40 pt-4" aria-hidden="true">
                    <span
                ...
                <div className="flex items-center justify-between px-6 py-3 border-t border-border text-xs text-muted-foreground/50">
                    <p>
                        <span className="text-accent">▸</span> nicholas-abeleda ©2026 ·{" "}
                        <Link
                            href="/privacy"
