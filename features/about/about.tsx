    ...
    return (
        <section id="about" className="w-full flex flex-col gap-16">
            ...
            <div className="flex items-center gap-4">
                <span className="text-[10px] font-bold tracking-[.3em] uppercase text-muted-foreground/40">
                    About
                </span>
                <div className="flex-1 border-t border-border" />
                <span className="text-[10px] text-muted-foreground/30 tracking-widest">$ cat about.md</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-10 items-end">
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative w-full aspect-[3/4] max-w-[280px] rounded-2xl border border-border overflow-hidden bg-card">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                            <p className="text-[11px] text-muted-foreground/50 tracking-widest mb-0.5">$ whoami</p>
                            <p className="text-[15px] font-bold text-foreground leading-tight">{PERSON.name}</p>
                    ...
                    <div className="flex flex-col gap-0 rounded-xl border border-border overflow-hidden">
                        {FACTS.map((f, i) => (
                            <div key={f.label} className={`flex items-center justify-between px-4 py-2.5 ${i < FACTS.length - 1 ? "border-b border-border" : ""} bg-card`}>
                                <span className="text-[10px] text-muted-foreground/40 tracking-widest uppercase">{f.label}</span>
                ...
                <div className="flex flex-col gap-8 lg:pb-2">
                    ...
                    <div style={{ letterSpacing: "-0.03em" }} className="leading-[0.9]">
                        ...
                        <span className="block font-extrabold text-[clamp(48px,7vw,100px)] text-foreground">
                            I&apos;m {PERSON.name.split(" ")[0]}.
                        </span>
                        <span className="block font-extrabold text-[clamp(36px,5.5vw,80px)] text-secondary">
                            Full-Stack
                        </span>
                        <span
                    ...
                    <div className="flex flex-col gap-3 max-w-lg">
                        <p className="text-[clamp(13px,1.5vw,15px)] text-muted-foreground leading-relaxed">
                            I design and ship <span className="text-foreground font-semibold">full-stack systems</span> end-to-end.
                            My workflow lives in the terminal — I run <span className="text-secondary font-semibold">Linux</span> on
                            everything and treat the command line as home.
                        </p>
                        <p className="text-[clamp(13px,1.5vw,15px)] text-muted-foreground leading-relaxed">
                            I care about <span className="text-primary font-semibold">performance</span>, clean architecture,
                            and interfaces that feel intentional. If it ships, it ships right.
                        </p>
                    </div>
                    ...
                    >
                        <span className="text-[13px] text-foreground font-semibold">Contact Me</span>
                        <span className="w-6 h-6 rounded-full bg-foreground flex items-center justify-center group-hover:bg-primary transition-colors duration-200">
                            <svg width="11" height="11" viewBox="0 0 12 12" fill="none">
                                <path d="M2 10L10 2M10 2H4M10 2V8" stroke="#0a0a0a" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </span>
                    </a>
                </div>
