...
const appendixImages: Record<string, string[]> = {
    ...
    appC: ["/images/appendices/appendix-c/id-back.jpg", "/images/appendices/appendix-c/id-front.jpg", "/images/appendices/appendix-c/validated-id.png",],
    ...
    appH: ["/images/appendices/appendix-h/0c262d4f-7396-461f-8ee8-b3fb8ca9c079-0.jpg", "/images/appendices/appendix-h/0c262d4f-7396-461f-8ee8-b3fb8ca9c079-1.jpg",],
    appI: ["/images/appendices/appendix-i/moa-1.jpg", "/images/appendices/appendix-i/moa-2.jpg", "/images/appendices/appendix-i/moa-3.jpg", "/images/appendices/appendix-i/moa-4.jpg", "/images/appendices/appendix-i/moa-5.jpg", "/images/appendices/appendix-i/moa-6.jpg", "/images/appendices/appendix-i/moa-7.jpg", "/images/appendices/appendix-i/moa-8.jpg",],
    appJ: ["/images/appendices/appendix-j/attendance-january.png", "/images/appendices/appendix-j/attendance-february.png", "/images/appendices/appendix-j/attendance-march.png", "/images/appendices/appendix-j/attendance-april.png",],
    ...
    appQ: ["/images/appendices/appendix-q/page-1.jpg", "/images/appendices/appendix-q/page-2.jpg"],
};
...
export function AppendixViewer({
    ...
    // Reset index when appendixId changes
    useEffect(() => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={() => onOpenChange(false)}>
            <div className="relative bg-card border border-border rounded-2xl overflow-hidden shadow-2xl flex flex-col max-w-4xl w-[95vw] max-h-[95vh]" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-between px-4 py-3 border-b border-border shrink-0">
                    ...
                    <button onClick={() => onOpenChange(false)} className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-muted transition text-muted-foreground hover:text-foreground shrink-0">
                        <X size={14} />
                    </button>
                </div>
                <div className="flex-1 overflow-auto flex items-center justify-center bg-background p-2 min-h-0">
                    <div className="relative w-full max-h-[75vh] flex items-center justify-center">
                        <Image src={images[currentIndex]} alt={`${label} - image ${currentIndex + 1} of ${images.length}`} width={800} height={600} sizes="95vw" className="object-contain rounded-lg max-h-[75vh] w-auto" />
                    </div>
                </div>
