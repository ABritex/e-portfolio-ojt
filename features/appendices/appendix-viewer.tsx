...
export function AppendixViewer({
  ...
  return (
    ...
    >
      <div
        className="relative bg-card border border-border rounded-2xl overflow-hidden shadow-2xl flex flex-col max-w-4xl w-[95vw] max-h-[95vh]"
        ...
        <div className="flex-1 overflow-auto flex items-center justify-center bg-background p-2 min-h-0">
          <div className="relative w-full max-h-[75vh] flex items-center justify-center">
            <Image
              ...
              height={600}
              sizes="95vw"
              className="object-contain rounded-lg max-h-[75vh] w-auto"
            />
          </div>
        </div>
