...
export default function Hero() {
    return (
        <main id="home" className="relative flex-1 min-h-0 flex flex-col items-center justify-center px-6 py-8 overflow-hidden">
            <div className="relative w-full max-w-4xl flex flex-col items-center">
                ...
                <div className="z-10 text-center leading-[0.88] mb-6 animate-[fadeUp_0.8s_0.1s_cubic-bezier(0.16,1,0.3,1)_both]" style={{ letterSpacing: "-0.03em" }}                >
                    <span
